...
func (s *StubStoreRepository) Read(data interface{}) error {
...
func (s *StubStoreRepository) Write(data interface{}) error {
	return nil
}

func NewStore() Store {
	return &StubStoreRepository{"", false}
}
...
func TestUpdateName(t *testing.T) {
	...
	assert.True(t, store.(*StubStoreRepository).callReadMethod)
